...
CREATE TABLE USER(
	...
	BACKUP_PASSWORD VARCHAR(30) NOT NULL,
	EMAIL VARCHAR(30) UNIQUE NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS USER_ID_SEQ MINVALUE 1 INCREMENT BY 1 START WITH 1;
DROP SEQUENCE IF EXISTS TRAINER_ID_SEQ;
CREATE SEQUENCE IF NOT EXISTS TRAINER_ID_SEQ MINVALUE 1 INCREMENT BY 1 START WITH 1;
...
INSERT INTO USER(USER_ID, PASSWORD, BACKUP_PASSWORD, EMAIL, FIRST_NAME, MIDDLE_NAME, LAST_NAME, ROLE, HOME_PHONE, MOBILE_PHONE, TOKEN) VALUES( USER_ID_SEQ.NEXTVAL, 'bsmalls@email.com', 'pass', 'pass2', 'Brandon', 'Jerome', 'Smalls', 1, null, '8034144427', null);
INSERT INTO USER(USER_ID, PASSWORD, BACKUP_PASSWORD, EMAIL, FIRST_NAME, MIDDLE_NAME, LAST_NAME, ROLE, HOME_PHONE, MOBILE_PHONE, TOKEN) VALUES( USER_ID_SEQ.NEXTVAL, 'b@email.com', 'pass3', 'pass4', 'Brandon', 'Jerome', 'Smalls', 2, null, '8034144427', null);
------- CERTIFICATION TABLE ---------
